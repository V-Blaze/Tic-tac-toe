...
var checkWinner = function checkWinner() {
  var boxes = getBoxes();
  return boxes[0] == boxes[1] && boxes[1] == boxes[2] && boxes[0] != '' || boxes[3] == boxes[4] && boxes[4] == boxes[5] && boxes[3] != '' || boxes[6] == boxes[7] && boxes[7] == boxes[8] && boxes[6] != '' || boxes[0] == boxes[3] && boxes[3] == boxes[6] && boxes[0] != '' || boxes[1] == boxes[4] && boxes[4] == boxes[7] && boxes[1] != '' || boxes[2] == boxes[5] && boxes[5] == boxes[8] && boxes[2] != '' || boxes[0] == boxes[4] && boxes[4] == boxes[8] && boxes[0] != '' || boxes[2] == boxes[4] && boxes[4] == boxes[6] && boxes[2] != ''; // console.log(boxes)
};
...
var getBoxes = function getBoxes() {
  ...
  for (var i = 0; i <= boxes.length - 1; i++) {
    var curBox = document.querySelector("#".concat(boxes[i].id));
    var boxText = curBox === null || curBox === void 0 ? void 0 : curBox.innerText;
